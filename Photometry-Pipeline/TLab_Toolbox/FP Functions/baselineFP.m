...
% 240220 UPDATE: winSize and WinOv (in terms of numbers of samples) should always be an interger)
winSize = round(winSize * Fs); %Convert window size from seconds to samples
winOv = round(winOv * Fs); %Convert overlap window from seconds to samples
