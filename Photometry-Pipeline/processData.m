                    ...
                    switch choice
                            ...
                            try
                                ...
                                if modStatus == 1
                                    ...
                                    if isoStatus == 1
                                        ...
                                        data = JT_processDual(data,params);
                                    end
                                elseif modStatus == 2
                                    data = JT_processFP(data,params);
                                else
                        ...
                        case 3                            
                            try
                                ...
                                data = JT_processOnsetOffset(data,params);
                            ...
                            try
                                ...
                                data = JT_processRestOnsetOffset(data,params);
                        ...
                        case 4
                            try
                                ...
                                fprintf('Finisheddata. Processing Cross Correlation!\n\n');
                            catch
